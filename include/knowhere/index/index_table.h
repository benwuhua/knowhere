...
static std::set<std::pair<std::string, VecType>> legal_knowhere_index = {
    ...
    {IndexEnum::INDEX_PIPNN_DISKANN, VecType::VECTOR_FLOAT},
    {IndexEnum::INDEX_PIPNN_DISKANN, VecType::VECTOR_FLOAT16},
    {IndexEnum::INDEX_PIPNN_DISKANN, VecType::VECTOR_BFLOAT16},
