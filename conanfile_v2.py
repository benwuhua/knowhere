...
class KnowhereConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("openssl/1.1.1t@cbu3rd/stable", transitive_headers=True, transitive_libs=True)
        ...
        self.requires("libcurl/8.2.1@cbu3rd/stable", transitive_headers=True, transitive_libs=True)
