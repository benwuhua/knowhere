...
class KnowhereConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("glog/0.6.0@cbu3rd/stable", transitive_headers=True, transitive_libs=True, force=True)
        self.requires("nlohmann_json/3.11.2@cbu3rd/stable", transitive_headers=True, transitive_libs=True)
        self.requires("openssl/1.1.1q@cbu3rd/stable", transitive_headers=True, transitive_libs=True, force=True)
        self.requires("prometheus-cpp/1.1.0@cbu3rd/stable", transitive_headers=True, transitive_libs=True)
        self.requires("zlib/1.2.13@cbu3rd/stable", transitive_headers=True, transitive_libs=True, force=True)
        ...
        if self.options.with_benchmark:
            self.requires("gtest/1.13.0@cbu3rd/stable", transitive_headers=True, transitive_libs=True)
            self.requires("hdf5/1.14.0@cbu3rd/stable", transitive_headers=True, transitive_libs=True)
