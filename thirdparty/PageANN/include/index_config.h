...
class IndexConfigBuilder
{
  public:
    ...
    IndexConfigBuilder &with_index_write_params(std::shared_ptr<IndexWriteParameters> index_write_params_ptr)
    {
        ...
        {
            pageann::cout << "Passed, empty build_params while creating index config" << std::endl;
            return *this;
        }
    ...
    IndexConfigBuilder &with_index_search_params(std::shared_ptr<IndexSearchParams> search_params_ptr)
    {
        ...
        {
            pageann::cout << "Passed, empty search_params while creating index config" << std::endl;
            return *this;
        }
    ...
    IndexConfig build()
    {
        ...
        if (_dynamic_index && _num_frozen_pts == 0)
        {
            pageann::cout << "_num_frozen_pts passed as 0 for dynamic_index. Setting it to 1 for safety." << std::endl;
            _num_frozen_pts = 1;
        }
