...
{
  public:
    DISKANN_DLLEXPORT Distance(pageann::Metric dist_metric) : _distance_metric(dist_metric)
    {
    }
    ...
    DISKANN_DLLEXPORT virtual pageann::Metric get_metric() const;
  ...
  protected:
    pageann::Metric _distance_metric;
...
{
  public:
    DistanceCosineInt8() : Distance<int8_t>(pageann::Metric::COSINE)
    {
    }
...
{
  public:
    DistanceL2Int8() : Distance<int8_t>(pageann::Metric::L2)
    {
    }
...
{
  public:
    AVXDistanceL2Int8() : Distance<int8_t>(pageann::Metric::L2)
    {
    }
    DISKANN_DLLEXPORT virtual float compare(const int8_t *a, const int8_t *b, uint32_t length) const;
};
...
{
  public:
    DistanceCosineFloat() : Distance<float>(pageann::Metric::COSINE)
    {
    }
...
{
  public:
    DistanceL2Float() : Distance<float>(pageann::Metric::L2)
    {
    }
...
{
  public:
    AVXDistanceL2Float() : Distance<float>(pageann::Metric::L2)
    {
    }
    DISKANN_DLLEXPORT virtual float compare(const float *a, const float *b, uint32_t length) const;
};
...
{
  public:
    SlowDistanceL2() : Distance<T>(pageann::Metric::L2)
    {
    }
...
{
  public:
    SlowDistanceCosineUInt8() : Distance<uint8_t>(pageann::Metric::COSINE)
    {
    }
...
{
  public:
    DistanceL2UInt8() : Distance<uint8_t>(pageann::Metric::L2)
    {
    }
...
{
  public:
    DistanceInnerProduct() : Distance<T>(pageann::Metric::INNER_PRODUCT)
    {
    }

    DistanceInnerProduct(pageann::Metric metric) : Distance<T>(metric)
    {
    }
...
template <typename T> class DistanceFastL2 : public DistanceInnerProduct<T>
{
  ...
  public:
    DistanceFastL2() : DistanceInnerProduct<T>(pageann::Metric::FAST_L2)
    {
    }
...
{
  public:
    AVXDistanceInnerProductFloat() : Distance<float>(pageann::Metric::INNER_PRODUCT)
    {
    }
    DISKANN_DLLEXPORT virtual float compare(const float *a, const float *b, uint32_t length) const;
};
...
class AVXNormalizedCosineDistanceFloat : public Distance<float>
{
  ...
  public:
    AVXNormalizedCosineDistanceFloat() : Distance<float>(pageann::Metric::COSINE)
    {
    }
    DISKANN_DLLEXPORT virtual float compare(const float *a, const float *b, uint32_t length) const
    {
